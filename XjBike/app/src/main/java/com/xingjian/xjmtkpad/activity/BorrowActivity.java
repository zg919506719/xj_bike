...
//                                byte[] mCmd0B = Conversion.HexString2Bytes(pileOutIdArr[i] + "000B");//0x0B 锁桩车辆状态读取
//                                mApi.canCmd(0, mCmd0B, mCmd0B.length);
//                                break;
//                            }
//                        }
//                        break;
...
//                    case "8E"://0x0E 请求时间
//                        byte[] mCmd0E = Conversion.HexString2Bytes(mPileID + "00CE" + new SimpleDateFormat("yyyyMMddHHmm").format(new Date()));
//                        mApi.canCmd(0, mCmd0E, mCmd0E.length);
//                        break;
//
...
//                    case "85"://0x05 锁桩工作模式请求
//                        byte[] mCmd05 = Conversion.HexString2Bytes(mPileID + "00C501");
//                        mApi.canCmd(0, mCmd05, mCmd05.length);
//                        break;
//
//                    case "87"://0x07 站点ID请求
//                        byte[] mCmd07 = Conversion.HexString2Bytes(mPileID + "00C70059");
//                        mApi.canCmd(0, mCmd07, mCmd07.length);
//                        break;
//
...
////                            mApi.canCmd(0, mCmd08, mCmd08.length);
//                        break;
//
...
//                        mApi.canCmd(0, mCmd09, mCmd09.length);
//                        break;
//
...
////                            mApi.canCmd(0, mCmd0D, mCmd0D.length);
//                        break;
//                }
            }
